...
<div id="sidebar">
    <ul>
        ...
        <li >
            <a href="add_new_unit.php"><i class="icon icon-th-list"></i><span>Add New Unit</span></a>
        </li>

        <li >
            <a href="add_new_product.php"><i class="icon icon-th-list"></i><span>Add New Product</span></a>
        </li>
